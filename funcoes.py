...
def corrigir_codigo():
    """
    Faz uma análise básica do código digitado pelo usuário
    e sugere possíveis melhorias ou erros comuns.
    """
    ...
    while True:
        ...
        print("\nCole seu código Python ou digite 'voltar' para sair.")
        ...
        # Verificação simples global

        if "print" not in codigo:
            print("⚠ Não encontrei uso da função print().")
            erros_encontrados = True

        if "def" in codigo and ":" not in codigo:
            print("⚠ Funções precisam de ':' após a definição.")
            erros_encontrados = True
        ...
        for linha in linhas:
            ...
            if "input" in linha and "(" not in linha:
                print("⚠ Possível erro no uso do input().")
                erros_encontrados = True

            if ("if" in linha or "while" in linha or "for" in linha) and ":" not in linha:
                print("⚠ Estruturas como if/while/for precisam de ':' no final.")
                erros_encontrados = True

        if not erros_encontrados:
            print("✔ Nenhum erro básico identificado.")
            print("Seu código parece estar estruturalmente correto!")
...
def configuracoes():
    ...
    while True:
        ...
        if opcao == "1":
            ...
            print("\nPyLearn - Assistente de aprendizado de Python")
            print("Versão: 1.0")
